  ...
  return (
    <div className={theme}>
      <ReactMarkdown
        ...
        components={{
          h1: ({ children }) => (
            <h1 style={{ color: styles.accent, fontSize: '32px', margin: '32px 0 16px 0', fontWeight: 700, lineHeight: 1.2 }}>
              {children}
            </h1>
          ),
          h2: ({ children }) => (
            <h2 style={{ color: styles.accent, fontSize: '28px', margin: '28px 0 14px 0', fontWeight: 600, lineHeight: 1.3 }}>
              {children}
            </h2>
          ),
          h3: ({ children }) => (
            <h3 style={{ color: styles.accent, fontSize: '24px', margin: '24px 0 12px 0', fontWeight: 600, lineHeight: 1.4 }}>
              {children}
            </h3>
          ),
          h4: ({ children }) => (
            <h4 style={{ color: styles.accent, fontSize: '20px', margin: '20px 0 10px 0', fontWeight: 600, lineHeight: 1.4 }}>
              {children}
            </h4>
          ),
          h5: ({ children }) => (
            <h5 style={{ color: styles.accent, fontSize: '18px', margin: '18px 0 8px 0', fontWeight: 600, lineHeight: 1.5 }}>
              {children}
            </h5>
          ),
          h6: ({ children }) => (
            <h6 style={{ color: styles.accent, fontSize: '16px', margin: '16px 0 6px 0', fontWeight: 600, lineHeight: 1.5 }}>
              {children}
            </h6>
          ),
          p: ({ children }) => (
